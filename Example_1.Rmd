...
### Example code
To illustrate the usage of the package I simulate a dataset below. The design contains two types of pedigrees, the first contains sibling trios with one 
```{r sim_relStruct}
