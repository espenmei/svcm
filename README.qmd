...
Model expressions are evaluated in a strict environment. External objects should be passed via `const()`, and non-base functions should be called with explicit namespaces (for example `Matrix::t()`).
